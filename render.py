...
def render_html(today_hours, week_hours, now, diagnostics):
    ...
    css = (
        ...
        ".top{border-bottom:2px solid #111;padding-bottom:6px;font-size:3.2vmin;}"
        ".optima{font-size:2.2vmin;color:#555;}"
        ...
        ".bottom{border-top:2px solid #111;padding-top:6px;font-size:2.4vmin;}"
    )
